...
/*
 * SPIR-V 1.3 diagnostic variant:
 *
 * layout(push_constant) uniform PC { uint64_t address; } pc;
 * void main() {
 *    uint64_t divergent_hi = uint64_t(gl_GlobalInvocationID.x) << 32;
 *    uint64_t effective = pc.address ^ divergent_hi;
 *    *(PhysicalStorageBuffer uint *)effective = 0x12345678u;
 * }
 *
 * With the 1x1x1 dispatch used by this probe, GlobalInvocationID.x is 0 at
 * runtime, so "effective" is exactly pc.address. However, because the divergent
 * value affects the upper 32 bits through XOR, ACO cannot represent it merely as
 * an SGPR64 base plus a VGPR32 byte offset. This is intended to force a true
 * VGPR64 GLOBAL address path.
 */
static const uint32_t bda_store_spv[] = {
   0x07230203, 0x00010300, 0x00000000, 0x0000001a, 0x00000000, 0x00020011,
   0x00000001, 0x00020011, 0x0000000b, 0x00020011, 0x000014e3, 0x0009000a,
   0x5f565053, 0x5f52484b, 0x73796870, 0x6c616369, 0x6f74735f, 0x65676172,
   0x6675625f, 0x00726566, 0x0003000e, 0x000014e4, 0x00000001, 0x0006000f,
   0x00000005, 0x00000001, 0x6e69616d, 0x00000000, 0x0000000f, 0x00060010,
   0x00000001, 0x00000011, 0x00000001, 0x00000001, 0x00000001, 0x00030047,
   0x00000006, 0x00000002, 0x00050048, 0x00000006, 0x00000000, 0x00000023,
   0x00000000, 0x00040047, 0x0000000f, 0x0000000b, 0x0000001c, 0x00020013,
   0x00000002, 0x00030021, 0x00000003, 0x00000002, 0x00040015, 0x00000004,
   0x00000020, 0x00000000, 0x00040015, 0x00000005, 0x00000040, 0x00000000,
   0x0003001e, 0x00000006, 0x00000005, 0x00040020, 0x00000007, 0x00000009,
   0x00000006, 0x0004003b, 0x00000007, 0x00000008, 0x00000009, 0x0004002b,
   0x00000004, 0x00000009, 0x00000000, 0x00040020, 0x0000000a, 0x00000009,
   0x00000005, 0x00040020, 0x0000000b, 0x000014e5, 0x00000004, 0x0004002b,
   0x00000004, 0x0000000c, 0x12345678, 0x00040017, 0x0000000d, 0x00000004,
   0x00000003, 0x00040020, 0x0000000e, 0x00000001, 0x0000000d, 0x0004003b,
   0x0000000e, 0x0000000f, 0x00000001, 0x0005002b, 0x00000005, 0x00000010,
   0x00000020, 0x00000000, 0x00050036, 0x00000002, 0x00000001, 0x00000000,
   0x00000003, 0x000200f8, 0x00000011, 0x00050041, 0x0000000a, 0x00000012,
   0x00000008, 0x00000009, 0x0004003d, 0x00000005, 0x00000013, 0x00000012,
   0x0004003d, 0x0000000d, 0x00000014, 0x0000000f, 0x00050051, 0x00000004,
   0x00000015, 0x00000014, 0x00000000, 0x00040071, 0x00000005, 0x00000016,
   0x00000015, 0x000500c4, 0x00000005, 0x00000017, 0x00000016, 0x00000010,
   0x000500c6, 0x00000005, 0x00000018, 0x00000013, 0x00000017, 0x0004007c,
   0x0000000b, 0x00000019, 0x00000018, 0x0005003e, 0x00000019, 0x0000000c,
...
run_child(const char *driver_path, uint64_t fence_timeout_ns)
{
   ...
   printf("driver: %s\n", driver_path);
   printf("work: one PhysicalStorageBuffer uint store = 0x12345678 (forced VGPR64 address)\n");
